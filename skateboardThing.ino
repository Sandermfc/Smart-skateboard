...
bool frontLift()
{
  ...
  if((states[(frontOfTable+1)%numSavedStates].absoluteHeight1)+2 < (states[frontOfTable].absoluteHeight1)-3){
    flag1 = true;
  ...
  if((states[(frontOfTable+1)%numSavedStates].absoluteHeight2)-2 < (states[frontOfTable].absoluteHeight2)-3){
    flag2 = true;
...
bool backLift()
{
  ...
  {
    if((states[(frontOfTable+1)%numSavedStates].absoluteHeight1) < (states[frontOfTable].absoluteHeight1))
    {
  ...
  {
    if((states[(frontOfTable+1)%numSavedStates].absoluteHeight2) < (states[frontOfTable].absoluteHeight2))
    {
      Serial.println(F("+++++++++++++++++++++++++++++++++++++++++++++++++++++++"));
      delay(20);
      return true;
...
bool getMaxHeight()
{
  ...
  if(states[frontOfTable].absoluteHeight1 < states[(frontOfTable+1)%numSavedStates].absoluteHeight1 && states[frontOfTable].absoluteHeight2 < states[(frontOfTable+1)%numSavedStates].absoluteHeight2)
  {
    if(states[frontOfTable].absoluteHeight1 > states[frontOfTable].absoluteHeight2)
    {
      maxHeight = states[frontOfTable].absoluteHeight1; 
    }
    else
    {
      maxHeight = states[frontOfTable].absoluteHeight2; 
    }
...
bool landed()
{
  ...
  if((states[frontOfTable].absoluteHeight1 +2 > baseHeight1 && states[frontOfTable].absoluteHeight1 -2 < baseHeight1) && ((states[frontOfTable].absoluteHeight2 +2 > baseHeight2 && states[frontOfTable].absoluteHeight2 -2 < baseHeight2)))
  {
    Serial.print("//////////////////////////////////////////////////////");
    delay(2000);
    return true;
